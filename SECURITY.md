...
6. Ship the fix and announce per [RELEASE_DISTRIBUTION_PLAYBOOK](docs/RELEASE_DISTRIBUTION_PLAYBOOK.md)

## Scope

This SECURITY.md covers `claude-code-fleet-cockpit-template` (this repository). For other PALIOS-TAEY products, see their respective `SECURITY.md` files:
